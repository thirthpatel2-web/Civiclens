...
export function createEndpoints(api: ApiClient) {
  ...
  return {
    ...
    createRti: (body: { subject: string; public_authority: string; questions: string[]; applicant_name: string; applicant_address: string; language?: string; life_or_liberty?: boolean }) => api.post<T.RtiApplication>('/rti', body),
