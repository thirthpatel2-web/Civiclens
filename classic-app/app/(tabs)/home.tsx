...
function buildPillars(colors: ThemeColors): Pillar[] {
  return [
    ...
    { icon: 'business', titleKey: 'nav.rti', sub: 'Section 6(1)/7(1) application with a precise questionnaire', tag: 'RTI Act 2005', color: colors.accentSaffron, tint: withAlpha(colors.accentSaffron, 0.12), href: '/(tabs)/report?tab=rti' },
