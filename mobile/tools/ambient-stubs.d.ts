...
declare module 'react-native' { export const View: any, Text: any, TextInput: any, ScrollView: any, Pressable: any, Image: any, Switch: any, ActivityIndicator: any, StyleSheet: { create<T>(x: T): T }, Linking: any, AppState: any, Platform: any; export type TextInputProps = any; export type ViewStyle = any; }
